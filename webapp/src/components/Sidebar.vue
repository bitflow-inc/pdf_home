<template>
  ...
  <section class="bg-gray-800 text-center fixed bottom-0 top-0 left-0 h-16 md:h-screen">
    ...
    <div class="absolute bottom-0 w-full px-6" style="height: 36px;">
      <img src="/img/ic-maker.png">
    </div>
  </section>
